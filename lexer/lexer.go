...
import (
	...
	"github.com/BasitRaza228/monkey-lang-compiler/token"
)
...
func (l *Lexer) readNumber() string {
	...
	for isDigit(l.char) || (!hasDot && l.char == '.') {
		if l.char == '.' {
			hasDot = true
		}
		l.readChar()
...
// More inclusive name since it checks all digits
...
func (l *Lexer) NextToken() token.Token {
	...
	default:
		if isLetter(l.char) {
			...
			fmt.Println("Reading digit here")
